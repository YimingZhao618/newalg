...
from modules.mixers.qstrans import QSTransMixer #传入qstrasn mixer
...
def calculate_n_step_td_target(mixer, target_mixer, target_max_qvals, batch, rewards, terminated, mask, gamma, td_lambda,
    ...
    with th.no_grad():
        ...
        elif mixer == "qstrans":  # 传入qstrasn mixer
...
class NQLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        elif args.mixer == "qstrans":# 加入qstrans mixer
            self.mixer = QSTransMixer(args)
        elif args.mixer == "vdn":
            self.mixer = VDNMixer()
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        elif self.args.mixer == "qstrans": # 加入qstrans mixer
